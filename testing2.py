...
# ---------- Load CSVs from Streamlit Secrets ----------
def load_csv_from_secrets(secret_name):
    """Load CSV content directly from Streamlit Secrets"""
    csv_text = st.secrets[secret_name]
    df = pd.read_csv(StringIO(csv_text))
    return df

receivers_df = load_csv_from_secrets("emails_csv")
senders_df = load_csv_from_secrets("senders_csv")
